...
{
    private const string COMMON_PATH = "Assets/Dev/Feature/Dialogue/Dialogue/Editor/USS";
    ...
    public const string DIALOGUE_NODE_STYLESHEET_PATH = COMMON_PATH + "/DialogueNode.uss";
}
